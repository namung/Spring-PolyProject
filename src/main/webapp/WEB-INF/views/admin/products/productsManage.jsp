...
<link rel="stylesheet" href=".../resources/css/admin/products/productsManage.css">
<script
                    		...
                    		<tr>
                    			<td>
                    				<a class="move" href='<c:out value="${list.productId}"/>'>
                    					<c:out value="${list.productId}"></c:out>
                    				</a>
                    			</td>
...
$(".move").on("click", function(e){
	...
	moveForm.attr("action", "/admin/products/productsDetail");
	moveForm.submit();
});
