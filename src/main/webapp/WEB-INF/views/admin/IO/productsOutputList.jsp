                ...
                <div class="admin_navi_wrap">
                  <ul>
                      ...
                      <li>
                        ...
                        <li>
                            <a class="admin_list_04" href="/admin/IO/productsInput">입고 관리</a>
                        </li>                               
                      <li>
                          <a class="admin_list_03" href="/admin/IO/productsOutput">출고 등록</a>
                      </li>                                          
                  </ul>
                </div>
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>출고 목록</span></div>
                </div>
               <div class="goods_table_wrap">
	            	...
	            	<table class="details_table">
	            		<thead>
	            			<tr>
	            				...
	            				<td class="th_column_3">출고수량</td>
	            				<td class="th_column_4">출고날짜</td>
	            			</tr>
	            		</thead>	
	            		<tbody>
	            		...
	            		<tr>
	            			...
	            			<td><fmt:formatDate value="${list.salesDate}" pattern="yyyy-MM-dd-hh:mm:ss"/></td>
	            		</tr>
	            		</c:forEach>
	            		</tbody>
	            	</table>
	            ...
	            <!-- 상품 리스트 X -->
               	...
               	<div class="search_wrap">
               		<form id="searchForm" action="/admin/IO/productsOutputList" method="get">
                	...
                	<form id="moveForm" action="/admin/IO/productsOutputList" method="get" >
